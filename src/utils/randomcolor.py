"""Utility for generating a attractive random color"""
# Taken from https://github.com/kevinwuhoo/randomcolor-py/blob/master/randomcolor/__init__.py
...
class RandomColor:
    def __init__(self, seed=None):
        ...
        with open("assets/data/colormap.json") as f:
