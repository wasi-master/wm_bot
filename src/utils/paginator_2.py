...
from utils.functions import button_from_json, get_custom_emoji, get_p, print_error
...
class AkinatorView(discord.ui.View):
    """A view for displaying a paginator"""
        ...
        buttons = [
            {
                ...
                "emoji": get_custom_emoji("paginator.first") or "\u23ee\ufe0f",
                "row": 0,
            },
            {
                "label": "Previous",
                "style": discord.ButtonStyle.green,
                "emoji": get_custom_emoji("paginator.previous") or "\u23ee\ufe0f",
                "row": 0,
            },
            {
            ...
            },
            {
                "label": "Next",
                "style": discord.ButtonStyle.green,
                "emoji": get_custom_emoji("paginator.next") or "\u23ee\ufe0f",
                "row": 0,
            },
            {
                "label": "Last",
                "style": discord.ButtonStyle.blurple,
                "emoji": get_custom_emoji("paginator.last") or "\u23ee\ufe0f",
                "row": 0,
            },
            {
                "label": "Pause",
                "style": discord.ButtonStyle.gray,
                "emoji": get_custom_emoji("paginator.pause") or "\u23ee\ufe0f",
                "row": 1,
            },
            {
                "label": "Stop",
                "style": discord.ButtonStyle.gray,
                "emoji": get_custom_emoji("paginator.stop") or "\u23ee\ufe0f",
                "row": 1,
            },
            {
                "label": "Numbered",
                "style": discord.ButtonStyle.gray,
                "emoji": get_custom_emoji("paginator.numbered") or "\u23ee\ufe0f",
                "row": 1,
            },
        ]
    ...
    async def get_embed(self) -> discord.Embed:
        """Make a embed with all the current stats
