...
class Search(commands.Cog):
    ...
    async def fake_person(self, ctx):
        ...
        # HACK: should use a variable
        await ctx.send(
            embed=discord.Embed(
                title="This person does not exist",
                url="https://thispersondoesnotexist.com",
            )
            .set_image(url="attachment://fake_person.png")
            .set_footer(
                text="Randomly generates a person. go to https://thispersondoesnotexist.com to find more info"
            ),
