...
- [ ] Cache #TODO @ ([src/utils/bot.py:146](https://github.com/wasi-master/wm_bot/blob/main/src/utils/bot.py#L146))  
...
- [ ] re implement #TODO @ ([src/extensions/fun.py:294](https://github.com/wasi-master/wm_bot/blob/main/src/extensions/fun.py#L294))  
- [ ] fix #TODO @ ([src/extensions/fun.py:452](https://github.com/wasi-master/wm_bot/blob/main/src/extensions/fun.py#L452))  
...
- [ ] I don't know how this works but I need to to make it cleaner #HACK @ ([src/extensions/text.py:292](https://github.com/wasi-master/wm_bot/blob/main/src/extensions/text.py#L292))  
